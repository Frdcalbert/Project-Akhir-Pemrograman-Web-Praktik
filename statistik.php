...
<div class="container">
    <h1>Statistik</h1>
    <ul>
        <li>Total Pengguna: <?= htmlspecialchars($pdo->query("SELECT COUNT(*) FROM users")->fetchColumn()) ?></li>
        <li>Total Lowongan: <?= htmlspecialchars($pdo->query("SELECT COUNT(*) FROM jobs")->fetchColumn()) ?></li>
        <li>Total Lamaran: <?= htmlspecialchars($pdo->query("SELECT COUNT(*) FROM applications")->fetchColumn()) ?></li>
    </ul>
</div>
&nbsp;
&nbsp;
