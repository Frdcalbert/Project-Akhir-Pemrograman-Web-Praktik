...
// Ambil data lamaran
$applications = $pdo->query("SELECT a.*, j.job_title, u.full_name FROM applications a JOIN jobs j ON a.job_id = j.id JOIN users u ON a.applicant_id = u.user_id ORDER BY a.applied_at DESC")->fetchAll(PDO::FETCH_ASSOC);
?>
&nbsp;
&nbsp;
        ...
        <tbody>
            <?php foreach ($applications as $application): ?>
                <tr>
                    ...
                    <td>
                        <a href="adminedit_lamaran.php?id=<?= $application['application_id'] ?>" class="btn btn-warning">Edit</a>
                        <a href="admindelete_lamaran.php?id=<?= $application['application_id'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus lamaran ini?');">Hapus</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
